...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/font-awesom')}}e.min.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/bootstrap.m')}}in.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/owl.carouse')}}l.min.css">
